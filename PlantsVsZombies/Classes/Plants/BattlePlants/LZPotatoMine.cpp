...
SkeletonAnimation* PotatoMine::showPlantAnimationAndText()
{
	...
	SPSSpriteLayer::createPlantsText(1, SPSSpriteLayer::selectRequirementText(lta, PlantsType::PotatoMine, "POTATOMINE_4", "POTATOMINE_5"), Vec2(360, 870),
		lta.find("POTATOMINE_4")->second->fontsize, SPSSpriteLayer::isPlantIsCanSelect[static_cast<unsigned int>(PlantsType::PotatoMine)] ? Color3B::ORANGE : Color3B(255, 70, 0), false);
