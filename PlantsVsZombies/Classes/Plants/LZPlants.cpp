...
PlantsInformation::PlantsCardInformation::PlantsCardInformation(string a, string b, string c, unsigned int d, unsigned int e, int f,
	float g, float h, float i, bool j, PlantsType k, Color3B l, int m, int n)
{
	information[0] = a;
	information[1] = b;
	information[2] = c;
	quality = d;
	priority = e;
	plantsNeedSunNumbers = f;
	plantsCoolTime = g;
	PlantsSurPlusCoolTime = h;
	PlantsSurPlusPrecent = i;
	flippedX = j;
	type = k;
	color = l;
	requirement.x = m;
...
{
	{"SunFlower",              "PlantsIcon4",    "B",    3,   0,          0,         0,      0, 0,     false,   PlantsType::SunFlower,           Color3B(255,255,0),    0,     0       },  /* 向日葵 */
	{"PeaShooter",             "PlantsIcon5",    "C",    3,   1,          0,         0,      0, 0,     false,   PlantsType::PeaShooter,          Color3B(0,255,0),      0,     0       },  /* 豌豆射手 */
	{"Wallnut_body",           "PlantsIcon6",    "C",    3,   2,          0,         0,      0, 0,     false,   PlantsType::WallNut,             Color3B(140,80,10),    0,     0       },  /* 坚果墙 */
	{"PotatoMine",             "PlantsIcon7",    "C",    3,   3,          0,         0,      0, 0,     false,   PlantsType::PotatoMine,          Color3B(250,75,10),    50,    50      },  /* 土豆雷 */
	{"Cabbage",                "PlantsIcon3",    "B",    3,   4,          0,         0,      0, 0,     false,   PlantsType::CabbagePult,         Color3B(23,79,50),     100,   100     },  /* 卷心菜投手 */
	{"Marigold",               "PlantsIcon9",    "C",    3,   5,          0,         0,      0, 0,     false,   PlantsType::Marigold,            Color3B(255,127,0),    150,   150     },  /* 金盏花 */
	{"Torchwood",              "PlantsIcon2",    "C",    3,   6,          0,         0,      0, 0,     false,   PlantsType::Torchwood,           Color3B(255,0,0),      300,   300     },  /* 火炬树桩 */
	{"Spikeweed",              "PlantsIcon12",   "B",    3,   7,          0,         0,      0, 0,     false,   PlantsType::Spikeweed,           Color3B(0,64,0),       400,   400     },  /* 地刺 */
	{"Garlic",                 "PlantsIcon10",   "B",    3,   8,          0,         0,      0, 0,     false,   PlantsType::Garlic,              Color3B(218,205,182),  600,   600     },  /* 大蒜 */
	{"ScaredyShroom",          "PlantsIcon13",   "B",    3,   9,          0,         0,      0, 0,     false,   PlantsType::ScaredyShroom,       Color3B(163,73,164),   900,   900     },  /* 胆小菇 */
	{"IceBergLettuce",         "PlantsIcon15",   "B",    3,   10,         0,         0,      0, 0,     false,   PlantsType::IceBergLettuce,      Color3B(99,202,178),   1200,  1200    },  /* 冰莴苣 */
	{"CherryBomb",             "PlantsIcon7",    "A",    2,   11,         0,         0,      0, 0,     false,   PlantsType::CherryBomb,          Color3B(255,0,0),      2000,  2000    },  /* 樱桃炸弹 */
	{"Chomper",                "PlantsIcon8",    "B",    3,   12,         0,         0,      0, 0,     false,   PlantsType::Chomper,             Color3B(152,66,184),   2500,  2500    },  /* 大嘴花 */
	{"Squash",                 "PlantsIcon8",    "B",    3,   13,         0,         0,      0, 0,     false,   PlantsType::Squash,              Color3B(181,230,29),   3000,  3000    },  /* 倭瓜 */
	{"IcePeaShooter",          "PlantsIcon15",   "B",    2,   14,         0,         0,      0, 0,     false,   PlantsType::IcePeaShooter,       Color3B(47,202,207),   4000,  4000    },  /* 寒冰豌豆射手 */
	{"FirePeaShooter",         "PlantsIcon2",    "B",    2,   15,         0,         0,      0, 0,     false,   PlantsType::FirePeaShooter,      Color3B(255,0,0),      5000,  5000    },  /* 火焰豌豆射手 */
	{"LemonShooter",           "PlantsIcon10",   "A",    2,   16,         0,         0,      0, 0,     false,   PlantsType::AcidLemonShooter,    Color3B(232,199,23),   6000,  6000    },  /* 柠檬射手 */
	{"Blover",                 "PlantsIcon11",   "B",    3,   17,         0,         0,      0, 0,     false,   PlantsType::Blover,              Color3B(0,255,0),      6500,  6500    },  /* 三叶草 */
	{"SunFlowerTwin",          "PlantsIcon4",    "A",    2,   18,         0,         0,      0, 0,     false,   PlantsType::SunFlowerTwin,       Color3B(255,255,0),    7500,  7500    },  /* 双胞向日葵 */
	{"Imitater",               "PlantsIcon9",    "A",    2,   19,         0,         0,      0, 0,     false,   PlantsType::Imitater,            Color3B(255,127,0),    8500,  8500    },  /* 模仿者 */
	{"WaterMelonPult",         "PlantsIcon3",    "A",    2,   20,         0,         0,      0, 0,     false,   PlantsType::WaterMelonPult,      Color3B(23,79,50),     10000, 10000   },  /* 西瓜投手 */
	{"Pumpkin",                "PlantsIcon6",    "A",    2,   21,         0,         0,      0, 0,     false,   PlantsType::Pumpkin,             Color3B(255,127,0),    11000, 11000   },  /* 南瓜头 */
	{"Jalapeno",               "PlantsIcon2",    "A",    2,   22,         0,         0,      0, 0,     false,   PlantsType::Jalapeno,            Color3B(255,0,0),      12000, 12000   },  /* 火爆辣椒 */
	{"MagnetShroom",           "PlantsIcon",     "A",    2,   23,         0,         0,      0, 0,     false,   PlantsType::MagnetShroom,        Color3B(64,0,64),      13000, 13000   },  /* 磁力菇 */
	{"JalapenoVariation",      "PlantsIcon2",    "S",    1,   24,         0,         0,      0, 0,     true,    PlantsType::JalapenoVariation,   Color3B(100,0,0),      14500, 14500   },  /* 火爆辣椒变异 */
	{"FumeShroom",             "PlantsIcon13",   "S",    1,   25,         0,         0,      0, 0,     false,   PlantsType::FumeShroom,          Color3B(163,73,164),   16000, 16000   },  /* 大喷菇 */
	{"ThreePeaShooter",        "PlantsIcon5",    "S",    1,   26,         0,         0,      0, 0,     false,   PlantsType::ThreePeaShooter,     Color3B(0,255,0),      19000, 19000   },  /* 三头豌豆射手 */
	{"StarFruit",              "PlantsIcon9",    "S",    1,   27,         0,         0,      0, 0,     false,   PlantsType::StarFruit,           Color3B(255,127,0),    22000, 22000   },  /* 杨桃 */
	{"WinterMelonPult",        "PlantsIcon15",   "SSS",  1,   28,         0,         0,      0, 0,     false,   PlantsType::WinterMelonPult,     Color3B(47,202,207),   25000, 25000   },  /* 冰瓜投手 */
	{"GloomShroom",            "PlantsIcon13",   "SSS",  1,   29,         0,         0,      0, 0,     false,   PlantsType::GloomShroom,         Color3B(163,73,164),   29000, 29000   },  /* 忧郁菇 */
	{"CatTail",                "PlantsIcon11",   "SSS",  1,   30,         0,         0,      0, 0,     false,   PlantsType::CatTail,             Color3B(255,0,255),    34000, 34000   },  /* 香蒲 */
	{"Citron",                 "PlantsIcon",     "SS",   1,   31,         0,         0,      0, 0,     false,   PlantsType::Citron,              Color3B(0,255,255),    40000, 40000   },  /* 离子缘 */
	/* 植物图片名称 */         /* 标志名称 */    /*品质*/    /*优先级*/  /*阳光数*/  /*时间*/           /*反转*/       /*植物类型*/                   /* 颜色 */            /* 要求 */
};
#else
PlantsInformation::PlantsCardInformation plantsCardInformation[] =
{
	{"SunFlower",             "PlantsIcon4",    "B",    3,   0,          50,          7.5f,      0, 0,     false,   PlantsType::SunFlower,           Color3B(255,255,0),    0,     0       },  /* 向日葵 */
	{"PeaShooter",            "PlantsIcon5",    "C",    3,   1,          100,         7.5f,      0, 0,     false,   PlantsType::PeaShooter,          Color3B(0,255,0),      0,     0       },  /* 豌豆射手 */
	{"Wallnut_body",          "PlantsIcon6",    "C",    3,   2,          50,          30,        0, 0,     false,   PlantsType::WallNut,             Color3B(140,80,10),    0,     0       },  /* 坚果墙 */
	{"PotatoMine",            "PlantsIcon7",    "C",    3,   3,          25,          30,        0, 0,     false,   PlantsType::PotatoMine,          Color3B(250,75,10),    50,    50      },  /* 土豆雷 */
	{"Cabbage",               "PlantsIcon3",    "B",    3,   4,          100,         7.5f,      0, 0,     false,   PlantsType::CabbagePult,         Color3B(23,79,50),     100,   100     },  /* 卷心菜投手 */
	{"Marigold",              "PlantsIcon9",    "C",    3,   5,          50,          10,        0, 0,     false,   PlantsType::Marigold,            Color3B(255,127,0),    150,   150     },  /* 金盏花 */
	{"Torchwood",             "PlantsIcon2",    "C",    3,   6,          175,         7.5f,      0, 0,     false,   PlantsType::Torchwood,           Color3B(255,0,0),      300,   300     },  /* 火炬树桩 */
	{"Spikeweed",             "PlantsIcon12",   "B",    3,   7,          100,         7.5f,      0, 0,     false,   PlantsType::Spikeweed,           Color3B(0,64,0),       400,   400     },  /* 地刺 */
	{"Garlic",                "PlantsIcon10",   "B",    3,   8,          50,          10,        0, 0,     false,   PlantsType::Garlic,              Color3B(218,205,182),  600,   600     },  /* 大蒜 */
	{"ScaredyShroom",         "PlantsIcon13",   "B",    3,   9,          50,          7.5f,      0, 0,     false,   PlantsType::ScaredyShroom,       Color3B(163,73,164),   900,   900     },  /* 胆小菇 */
	{"IceBergLettuce",        "PlantsIcon15",   "B",    3,   10,         0,           20,        0, 0,     false,   PlantsType::IceBergLettuce,      Color3B(99,202,178),   1200,  1200    },  /* 冰莴苣 */
	{"CherryBomb",            "PlantsIcon7",    "A",    2,   11,         150,         37.5f,     0, 0,     false,   PlantsType::CherryBomb,          Color3B(255,0,0),      2000,  2000    },  /* 樱桃炸弹 */
	{"Chomper",               "PlantsIcon8",    "B",    3,   12,         150,         7.5f,      0, 0,     false,   PlantsType::Chomper,             Color3B(152,66,184),   2500,  2500    },  /* 大嘴花 */
	{"Squash",                "PlantsIcon8",    "B",    3,   13,         50,          30,        0, 0,     false,   PlantsType::Squash,              Color3B(181,230,29),   3000,  3000    },  /* 倭瓜 */
	{"IcePeaShooter",         "PlantsIcon15",   "B",    2,   14,         175,         10,        0, 0,     false,   PlantsType::IcePeaShooter,       Color3B(47,202,207),   4000,  4000    },  /* 寒冰豌豆射手 */
	{"FirePeaShooter",        "PlantsIcon2",    "B",    2,   15,         200,         10,        0, 0,     false,   PlantsType::FirePeaShooter,      Color3B(255,0,0),      5000,  5000    },  /* 火焰豌豆射手 */
	{"LemonShooter",          "PlantsIcon10",   "A",    2,   16,         175,         7.5f,      0, 0,     false,   PlantsType::AcidLemonShooter,    Color3B(232,199,23),   6000,  6000    },  /* 柠檬射手 */
	{"Blover",                "PlantsIcon11",   "B",    3,   17,         50,          7.5f,      0, 0,     false,   PlantsType::Blover,              Color3B(0,255,0),      6500,  6500    },  /* 三叶草 */
	{"SunFlowerTwin",         "PlantsIcon4",    "A",    2,   18,         100,         15,        0, 0,     false,   PlantsType::SunFlowerTwin,       Color3B(255,255,0),    7500,  7500    },  /* 双胞向日葵 */
	{"Imitater",              "PlantsIcon9",    "A",    2,   19,         0,           0,         0, 0,     false,   PlantsType::Imitater,            Color3B(255,127,0),    8500,  8500    },  /* 模仿者 */
	{"WaterMelonPult",        "PlantsIcon3",    "A",    2,   20,         225,         10,        0, 0,     false,   PlantsType::WaterMelonPult,      Color3B(23,79,50),     10000, 10000   },  /* 西瓜投手 */
	{"Pumpkin",               "PlantsIcon6",    "A",    2,   21,         150,         30,        0, 0,     false,   PlantsType::Pumpkin,             Color3B(255,127,0),    11000, 11000   },  /* 南瓜头 */
	{"Jalapeno",              "PlantsIcon2",    "A",    2,   22,         150,         37.5f,     0, 0,     false,   PlantsType::Jalapeno,            Color3B(255,0,0),      12000, 12000   },  /* 火爆辣椒 */
	{"MagnetShroom",          "PlantsIcon",     "A",    2,   23,         100,         10,        0, 0,     false,   PlantsType::MagnetShroom,        Color3B(64,0,64),      13000, 13000   },  /* 磁力菇 */
	{"JalapenoVariation",     "PlantsIcon2",    "S",    1,   24,         175,         37.5f,     0, 0,     true,    PlantsType::JalapenoVariation,   Color3B(100,0,0),      14500, 14500   },  /* 火爆辣椒变异 */
	{"FumeShroom",            "PlantsIcon13",   "S",    1,   25,         150,         7.5f,      0, 0,     false,   PlantsType::FumeShroom,          Color3B(163,73,164),   16000, 16000   },  /* 大喷菇 */
	{"ThreePeaShooter",       "PlantsIcon5",    "S",    1,   26,         225,         7.5f,      0, 0,     false,   PlantsType::ThreePeaShooter,     Color3B(0,255,0),      19000, 19000   },  /* 三头豌豆射手 */
	{"StarFruit",             "PlantsIcon9",    "S",    1,   27,         125,         7.5f,      0, 0,     false,   PlantsType::StarFruit,           Color3B(255,127,0),    22000, 22000   },  /* 杨桃 */
	{"WinterMelonPult",       "PlantsIcon15",   "SSS",  1,   28,         300,         20,        0, 0,     false,   PlantsType::WinterMelonPult,     Color3B(47,202,207),   25000, 25000   },  /* 冰瓜投手 */
	{"GloomShroom",           "PlantsIcon13",   "SSS",  1,   29,         275,         40,        0, 0,     false,   PlantsType::GloomShroom,         Color3B(163,73,164),   29000, 29000   },  /* 忧郁菇 */
	{"CatTail",               "PlantsIcon11",   "SSS",  1,   30,         225,         10,        0, 0,     false,   PlantsType::CatTail,             Color3B(255,0,255),    34000, 34000   },  /* 香蒲 */
	{"Citron",                "PlantsIcon",     "SS",   1,   31,         275,         15,        0, 0,     false,   PlantsType::Citron,              Color3B(0,255,255),    40000, 40000   },  /* 离子缘 */
	/* 植物图片名称 */         /* 标志名称 */    /*品质*/  /*优先级*/       /*阳光数*/   /*时间*/              /*反转*/       /*植物类型*/
};
#endif
...
void Plants::setPlantScale(float scale, bool isGetInitialScale)
{
