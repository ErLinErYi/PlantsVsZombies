...
SkeletonAnimation* Torchwood::showPlantAnimationAndText()
{
	...
	SPSSpriteLayer::createPlantsText(1, SPSSpriteLayer::selectRequirementText(lta, PlantsType::Torchwood, "TORCHWOOD_4", "ACIDLEMON_5"), Vec2(360, 870),
		lta.find("TORCHWOOD_4")->second->fontsize, SPSSpriteLayer::isPlantIsCanSelect[static_cast<unsigned int>(PlantsType::Torchwood)] ? Color3B::ORANGE : Color3B(255, 70, 0), false);
