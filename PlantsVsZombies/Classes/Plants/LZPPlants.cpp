...
PlantsInformation::PlantsCardInformation plantsCardInformation[] =
{
	...
	{"IceBergLettuce",         "PlantsIcon15",    "B",    3,    9,          0,         0,      0, 0,     false,   PlantsType::IceBergLettuce,      Color3B(99,202,178),  { 800,   500   }  },  /* 冰莴苣 */
	{"Chomper",                "PlantsIcon8",     "B",    3,    10,         0,         0,      0, 0,     false,   PlantsType::Chomper,             Color3B(152,66,184),  { 1000,  1000  }  },  /* 大嘴花 */
	{"IcePeaShooter",          "PlantsIcon15",    "A",    2,    11,         0,         0,      0, 0,     false,   PlantsType::IcePeaShooter,       Color3B(47,202,207),  { 2000,  2200  }  },  /* 寒冰豌豆射手 */
	{"FirePeaShooter",         "PlantsIcon2",     "A",    2,    12,         0,         0,      0, 0,     false,   PlantsType::FirePeaShooter,      Color3B::RED,         { 3000,  3500  }  },  /* 火焰豌豆射手 */
	{"LemonShooter",           "PlantsIcon10",    "A",    2,    13,         0,         0,      0, 0,     false,   PlantsType::AcidLemonShooter,    Color3B(232,199,23),  { 4500,  5000  }  },  /* 柠檬射手 */
	{"SunFlowerTwin",          "PlantsIcon4",     "A",    2,    14,         0,         0,      0, 0,     false,   PlantsType::SunFlowerTwin,       Color3B::YELLOW,      { 6000,  7000  }  },  /* 双胞向日葵 */
	{"WaterMelonPult",         "PlantsIcon3",     "A",    2,    15,         0,         0,      0, 0,     false,   PlantsType::WaterMelonPult,      Color3B(23,79,50),    { 7500,  9000  }  },  /* 西瓜投手 */
	{"Jalapeno",               "PlantsIcon2",     "A",    2,    16,         0,         0,      0, 0,     false,   PlantsType::Jalapeno,            Color3B::RED,         { 9000,  11500 }  },  /* 火爆辣椒 */
	{"JalapenoVariation",      "PlantsIcon2",     "S",    1,    17,         0,         0,      0, 0,     true,    PlantsType::JalapenoVariation,   Color3B(100,0,0),     { 11000, 14000 }  },  /* 火爆辣椒变异 */
	{"ThreePeaShooter",        "PlantsIcon5",     "S",    1,    18,         0,         0,      0, 0,     false,   PlantsType::ThreePeaShooter,     Color3B::GREEN,       { 12500, 16000 }  },  /* 三头豌豆射手 */
	{"StarFruit",              "PlantsIcon9",     "S",    1,    19,         0,         0,      0, 0,     false,   PlantsType::StarFruit,           Color3B::ORANGE,      { 15000, 18000 }  },  /* 杨桃 */
	{"WinterMelonPult",        "PlantsIcon15",    "SS",   1,    20,         0,         0,      0, 0,     false,   PlantsType::WinterMelonPult,     Color3B(47,202,207),  { 17500, 20500 }  },  /* 冰瓜投手 */
	{"Citron",                 "PlantsIcon",      "SS",   1,    21,         0,         0,      0, 0,     false,   PlantsType::Citron,              Color3B(0,255,255),   { 20000, 23000 }  },  /* 离子缘 */
	{"GloomShroom",            "PlantsIcon11",    "SSS",  1,    22,         0,         0,      0, 0,     false,   PlantsType::GloomShroom,         Color3B(163,73,164),  { 22666, 25666 }  },  /* 忧郁菇 */
...
PlantsInformation::PlantsCardInformation plantsCardInformation[] =
{
	...
	{"IceBergLettuce",        "PlantsIcon15",   "B",    3,   9,          0,           20,        0, 0,     false,   PlantsType::IceBergLettuce,      Color3B(99,202,178),  { 800,   500   }  },  /* 冰莴苣 */
	{"Chomper",               "PlantsIcon8",    "B",    3,   10,         150,         7.5f,      0, 0,     false,   PlantsType::Chomper,             Color3B(152,66,184),  { 1000,  1000  }  },  /* 大嘴花 */
	{"IcePeaShooter",         "PlantsIcon15",   "B",    2,   11,         175,         10,        0, 0,     false,   PlantsType::IcePeaShooter,       Color3B(47,202,207),  { 2000,  2200  }  },  /* 寒冰豌豆射手 */
	{"FirePeaShooter",        "PlantsIcon2",    "B",    2,   12,         200,         10,        0, 0,     false,   PlantsType::FirePeaShooter,      Color3B::RED,         { 3000,  3500  }  },  /* 火焰豌豆射手 */
	{"LemonShooter",          "PlantsIcon10",   "A",    2,   13,         175,         7.5f,      0, 0,     false,   PlantsType::AcidLemonShooter,    Color3B(232,199,23),  { 4500,  5000  }  },  /* 柠檬射手 */
	{"SunFlowerTwin",         "PlantsIcon4",    "A",    2,   14,         125,         15,        0, 0,     false,   PlantsType::SunFlowerTwin,       Color3B::YELLOW,      { 6000,  7000  }  },  /* 双胞向日葵 */
	{"WaterMelonPult",        "PlantsIcon3",    "A",    2,   15,         300,         10,        0, 0,     false,   PlantsType::WaterMelonPult,      Color3B(23,79,50),    { 7500,  9000  }  },  /* 西瓜投手 */
	{"Jalapeno",              "PlantsIcon2",    "A",    2,   16,         150,         40,        0, 0,     false,   PlantsType::Jalapeno,            Color3B::RED,         { 9000,  11500 }  },  /* 火爆辣椒 */
	{"JalapenoVariation",     "PlantsIcon2",    "S",    1,   17,         175,         40,        0, 0,     true,    PlantsType::JalapenoVariation,   Color3B(100,0,0),     { 11000, 14000 }  },  /* 火爆辣椒变异 */
	{"ThreePeaShooter",       "PlantsIcon5",    "S",    1,   18,         325,         7.5f,      0, 0,     false,   PlantsType::ThreePeaShooter,     Color3B::GREEN,       { 12500, 16000 }  },  /* 三头豌豆射手 */
	{"StarFruit",             "PlantsIcon9",    "S",    1,   19,         125,         7.5f,      0, 0,     false,   PlantsType::StarFruit,           Color3B::ORANGE,      { 15000, 18000 }  },  /* 杨桃 */
	{"WinterMelonPult",       "PlantsIcon15",   "SS",   1,   20,         300,         15,        0, 0,     false,   PlantsType::WinterMelonPult,     Color3B(47,202,207),  { 17500, 20500 }  },  /* 冰瓜投手 */
	{"Citron",                "PlantsIcon",     "SS",   1,   21,         350,         7.5f,      0, 0,     false,   PlantsType::Citron,              Color3B(0,255,255),   { 20000, 23000 }  },  /* 离子缘 */
	{"GloomShroom",           "PlantsIcon11",   "SSS",  1,   22,         300,         40,        0, 0,     false,   PlantsType::GloomShroom,         Color3B(163,73,164),  { 22666, 25666 }  },  /* 忧郁菇 */
	/* 植物图片名称 */       /* 标志名称 */    /*品质*/   /*优先级*/  /*阳光数*/   /*时间*/              /*反转*/       /*植物类型*/                   /* 颜色 */            /* 要求 */
};
#endif // _DEBUG
