...
unsigned int WUnlockDialogLayer::unlockNeedNumbers = 50;

WUnlockDialogLayer::WUnlockDialogLayer()
{
	WUnlockDialogLayer::unlockNeedNumbers = 50;
}

bool WUnlockDialogLayer::init()
{
...
void WUnlockDialogLayer::createDiglog()
{
...
void WUnlockDialogLayer::createText()
{
	...
	auto information1 = Text::create(StringUtils::format(str1->text.c_str(), WUnlockDialogLayer::unlockNeedNumbers), GAME_FONT_NAME_1, str1->fontsize);
...
void WUnlockDialogLayer::createButtons()
{
...
void WUnlockDialogLayer::deleteDialog()
{
