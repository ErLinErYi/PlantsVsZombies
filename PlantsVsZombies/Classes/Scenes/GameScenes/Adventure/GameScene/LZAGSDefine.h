...
#define GRASS_BIGMAP_INSIDE(__POSITION__,__X__,__Y__) (__POSITION__.x > GRASS_BIGMAP_POSITION_LEFT + 122 * __Y__ && __POSITION__.x < GRASS_BIGMAP_POSITION_LEFT + 122 * (__Y__ + 1) && __POSITION__.y > GRASS_BIGMAP_POSITION_BOTTOM + 138 * __X__ && __POSITION__.y < GRASS_BIGMAP_POSITION_BOTTOM + 138 * (__X__ + 1))
