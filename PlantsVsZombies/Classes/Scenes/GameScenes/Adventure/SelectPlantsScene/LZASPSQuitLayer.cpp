...
void SPSQuitLayer::createDialog()
{
	...
	/* 创建滑动条 */
	auto musicslider = createSlider(Vec2(600, 500), Vec2(150, 500), GAME_TEXT("音乐"), OptionScene_Slider::音乐,
		...
		nullptr,
		true);
	auto SoundEffectslider = createSlider(Vec2(600, 410), Vec2(150, 410), GAME_TEXT("音效"), OptionScene_Slider::音效,
		Sprite::createWithSpriteFrameName("bgFile.png"),
		Sprite::createWithSpriteFrameName("progressFile.png"),
		Sprite::createWithSpriteFrameName("thumbFile.png"),
		nullptr,
	...
	/* 创建复选框 */
	auto check = createCheckBox(Vec2(350, 340), Vec2(150, 340), GAME_TEXT("动态难度"), OptionScene_CheckBox::动态难度, "CheckBox2", "CheckBox", true);
	auto check1 = createCheckBox(Vec2(800, 340), Vec2(600, 340), GAME_TEXT("全屏"), OptionScene_CheckBox::全屏, "CheckBox2", "CheckBox", true);
	auto check2 = createCheckBox(Vec2(350, 265), Vec2(150, 265), GAME_TEXT("高帧率"), OptionScene_CheckBox::高帧率, "CheckBox2", "CheckBox", true);
	auto check3 = createCheckBox(Vec2(800, 265), Vec2(600, 265), GAME_TEXT("垂直同步"), OptionScene_CheckBox::垂直同步, "CheckBox2", "CheckBox", true);
	auto check4 = createCheckBox(Vec2(350, 190), Vec2(150, 190), GAME_TEXT("拉伸显示"), OptionScene_CheckBox::拉伸显示, "CheckBox2", "CheckBox", true);
	auto check5 = createCheckBox(Vec2(800, 190), Vec2(600, 190), GAME_TEXT("缓入动画"), OptionScene_CheckBox::缓入动画, "CheckBox2", "CheckBox", true);
	...
	/* 创建按钮 */
	GSPauseQuitLayer::createButton(Vec2(210, 100), GAME_TEXT("查看图鉴"), PauseQuitLayer_Button::查看图鉴);
	createButton(Vec2(830, 100), GAME_TEXT("退出游戏"), PauseQuitLayer_Button::退出游戏);
	createButton(Vec2(520, 100), GAME_TEXT("返回游戏"), PauseQuitLayer_Button::返回游戏);
}
