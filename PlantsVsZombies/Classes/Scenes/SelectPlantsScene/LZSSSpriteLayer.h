...
private:
	...
	void startGame();
	string selectRequirementText(map<string, LanguageTextAttribute*>& lta, int id, string str, string str1);
...
private:
	...
	const point requirement[4] = { {700,1200},{1500,2500},{4000,8000},{8000,15000} };
};
