...
#include "LZSEGameEasterEggs.h"

#include "Scenes/MainMenuScene/LZSMQuitScene.h"
#include "Based/LZBPlayMusic.h"
#include "Based/LZBVideoPlayer.h"
...
void GameEasterEggs::createEggText()
{
	...
	/* 文字彩蛋 */
	string buff = { "      真棒！！！首先祝贺你通过了此测试版的所有简单关卡。感谢你能够花费时间来关注此游戏。\
...
的关卡等着你去挑战。继续加油吧！\n\
      目前有14种僵尸和24种植物，植物和僵尸的动画都是本人做的，由于做动画的能力有限，有些僵尸和植物动画不能实现。\
