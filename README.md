...
# PlantsVsZombies
* **该项目目前Android用户已经突破100W,平均每天1000新用户。PC版本因技术原因无法统计。**
* **游戏引擎基于版本 Cocos2d-X v3.16** [[Cocos2dx 网站]](https://www.cocos.com/)
* **游戏全部使用c++开发**
...
## 项目说明 <br>
- 此游戏全部由本人自己制作完成。游戏具有很强的可玩性（目前主线有个208个关卡，除此之外还要“我是僵尸模”式、锤僵尸、植物试炼场等小游戏），今后会不定时更新（不断完善）。
- 该游戏相较于原版的优势有更大分辨率，更好的画质，更高的刷新率。游戏中的属性与原版有较大差别。难度比原版稍难（有困难和简单两种模式）。
- 游戏大部分的素材来源于原版游戏素材，少部分搜集于网络，以及自己制作。 
- 此游戏为仅供学习交流使用,不得用于商业用途，否则后果自负。
- 目前有43种僵尸和28种植物，植物和僵尸的动画都是本人做的，由于做动画的能力有限，有些僵尸和植物动画不能实现.（动画使用Dragonbones/Spine制作）。
...
## 运行要求
* 安装visual studio 2022 或者 visual studio 2019
